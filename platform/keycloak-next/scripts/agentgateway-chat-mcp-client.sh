...
# Open WebUI can run the authorization-code + PKCE flow on every /chat-* route
# that names it. Pinning these keeps a future edit from silently widening a
# browser client into a confidential or direct-grant one.
